...
me.greeter = function() {
	return 'Hello my name is ' + me.firstName + 'I live in ' + me.state 
}
...
let total = myNumbers.reduce((accumulator, currentValue) => {
...
// 	myNumbersIndex = myNumbers.push(index)
// })
